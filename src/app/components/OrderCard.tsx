    ...
    return (
      <>
        <div className="flex-1">
          {/* Stock Details */}
          <div className={`grid gap-2 mt-3 ${deviceType === "mobile" ? "grid-cols-2" : "grid-cols-3"}`}>
            ...
            <div className="bg-white text-black border rounded-lg p-2 text-center flex flex-col justify-center items-center">
              <div>
...
{       (deviceType === "desktop" || deviceType === "tablet") &&     <div className="bg-white text-black border rounded-lg p-2 text-center">
          ...
          <div className="grid grid-cols-1 mt-2">
            ...
            { deviceType === "mobile" &&   <div className="bg-white text-black border rounded-lg p-2 text-center">
              <p className="text-red-500 text-sm text">Total Amount</p>
              <p className="font-semibold">
                {formatePrice(
                  (product.qPcs || 0) * (product.set || 0) * product.price
            ...
            <textarea
              ...
              placeholder="Remark"
              className="bg-white text-black w-full mt-2 border rounded-lg px-2 py-2 text-sm"
            />
          </div>
        </div>
      </>
